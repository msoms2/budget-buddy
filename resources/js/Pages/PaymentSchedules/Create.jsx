...
export default function Create({ categories, paymentMethods, currencies }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(route('payment-schedules.store'));
  };
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <div className="container mx-auto py-6">
          <div className="mb-6">
            <h1 className="text-2xl font-semibold">Create Payment Schedule</h1>
            <p className="text-gray-500">Set up automatic payment reminders or recurring payments</p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Enter the details of your scheduled payment
                  </CardDescription>
                </CardHeader>
