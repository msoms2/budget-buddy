...
export default function PaymentScheduleSheet({ isOpen, onClose, currencies, categories, paymentMethods }) {
  const { data, setData, post, processing, errors, reset } = useForm({
    ...
    recurring_end_date: '',
    auto_process: false,
    type: 'expense' // Add default type as 'expense'
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(route('transactions.schedules.store'), {
      onSuccess: () => {
        onClose();
        reset();
      },
  ...
  return (
    ...
    >
      <SheetContent side="right" className="w-full sm:w-[540px] overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Create Payment Schedule</SheetTitle>
          <SheetDescription>Set up automatic payment reminders or recurring payments</SheetDescription>
        </SheetHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-6">
          ...
          <div className="flex justify-end space-x-4 mt-6">
            ...
            <Button type="submit" disabled={processing}>
              {processing ? 'Creating...' : 'Create Payment Schedule'}
            </Button>
          </div>
        </form>
      </SheetContent>
