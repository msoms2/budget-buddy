        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              ...
              <ChevronsUpDown className="ml-auto size-4 group-data-[collapsible=icon]:ml-0" />
            </SidebarMenuButton>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            className="w-[280px] rounded-lg z-[100]"
            ...
            <DropdownMenuGroup>
              <DropdownMenuItem asChild>
                <Link href={route('profile.index')} className="flex w-full cursor-pointer items-center">
